        ...
        {menuOpen && (
          ...
          >
            ...
            <motion.div 
              ...
              style={{ marginTop: 'auto', borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '2rem' }}
            >
...
const SideNavDots = () => {
  ...
  return (
    <div className="side-nav desktop-only" style={{ display: 'none' }}>
      {sections.map((id) => (
        <a
          key={id}
          href={`#${id}`}
